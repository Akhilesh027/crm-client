...
const AgentUsers = () => {
  ...
  // Fetch users from backend API and filter for Agent role
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h2 className="text-2xl font-semibold mb-6 text-center">Agent Users</h2>
          ...
          {filteredUsers.map((user) => (
            <div key={user._id} className="bg-white p-4 rounded shadow hover:shadow-lg transition">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className={`px-2 py-1 rounded text-white text-xs ${statusColors["Active"] || "bg-gray-400"}`}>
                  Active
                </span>
              </div>
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold">{new Date(viewUser.createdAt).toLocaleString()}</p>
              </div>
              <div>
                <p className="text-gray-500">Updated At</p>
                <p className="text-lg font-semibold">{new Date(viewUser.updatedAt).toLocaleString()}</p>
              </div>
            </div>
          </div>
        </div>
