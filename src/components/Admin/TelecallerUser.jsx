...
const TelecallerUsers = () => {
  ...
  // Fetch users from API and filter by telecaller role
  const fetchUsers = async () => {
    ...
    try {
      ...
      if (data.success) {
        const filtered = data.users.filter((user) => user.role === "telecaller");
        setUsers(filtered);
      } else {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <h2 className="text-2xl font-semibold mb-6 text-center">Telecaller Users</h2>
